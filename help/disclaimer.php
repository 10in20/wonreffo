...
{'GTM-K35JCCT':true});</script>
<!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-K35JCCT');</script>
<!-- End Google Tag Manager -->  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="robots" content="noimageindex, nofollow, nosnippet">
  <meta name="description" content="Disclaimer - Kerassentials">
  <title>Disclaimer - Kerassentials</title>
...
*{
    ...
    --main-font-family: Poppins, Roboto,"Helvetica Neue",Arial;
    ...
    --copywrite-background-color:#d2d2d2;
    --footer-font-color:black;
    --footer-hover-color:#3F8669;
    --footer-disclaimer-color:black;
    --footer-disclaimer-color-mob:black;
    
    
    --accent-color-light: #51b400;
    --accent-color-hard: #e33939;
    --accent-color-hard-contrast: #ffffff;
    /* PRICE BOX */
    --color-dark:transparent;
    --color-light:transparent;
}
    
</style>  <link rel="stylesheet" type="text/css" href="https://thekerassentials.com/statics/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="https://thekerassentials.com/statics/css/style.css">
  <link rel="stylesheet" type="text/css" href="https://thekerassentials.com/statics/css/webfont.css">
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-12 py-5">
						<p>
							The Kerassentials Site (the "Site") is an online
							...
							AND CONDITIONS, YOU MAY NOT ACCESS OR USE THE SITE. Kerassentials MAY MODIFY
							...
							trademark laws. The owner of the copyrights and trademarks are Kerassentials,
							...
							grant to Kerassentials a non-exclusive, royalty-free, worldwide, perpetual
							...
							Kerassentials by all means and in any media now known or hereafter developed.
							You also grant to Kerassentials the right to use your name in connection with
							...
							you shall have no recourse against Kerassentials for any alleged or actual infringement
							or misappropriation of any proprietary right in your communications to Kerassentials.
							<br>
							<br>
							<b>
								TRADEMARKS.
							...
							are the exclusive trademarks or service marks of Kerassentials. Other product
							...
							identified as being supplied by Kerassentials, Kerassentials does not operate,
							control or endorse any information, products or services on the Internet in any
							way. Except for Kerassentials - identified information, products or services,
							...
							Kerassentials. You also understand that Kerassentials cannot and does not
							...
							INTERNET. Kerassentials PROVIDES THE SITE AND RELATED INFORMATION "AS
							...
							SERVICE PROVIDED THROUGH THE SERVICE OR ON THE INTERNET GENERALLY, AND Kerassentials SHALL NOT BE LIABLE FOR ANY COST OR DAMAGE ARISING EITHER DIRECTLY OR
							...
							THE INTERNET GENERALLY. Kerassentials DOES NOT WARRANT THAT THE SERVICE WILL BE
							...
							ACCESS TO SUCH MATERIALS IS AT YOUR RISK. Kerassentials HAS NO CONTROL OVER AND
							...
							<br>
							<br>
							IN NO EVENT WILL Kerassentials BE LIABLE FOR (I) ANY INCIDENTAL, CONSEQUENTIAL,
							...
							DELAY OF SUCH INFORMATION OR SERVICE. EVEN Kerassentials OR ITS AUTHORIZED
							...
							IN SUCH STATES Kerassentials LIABILITY IS LIMITED TO THE GREATEST EXTENT PERMITTED BY LAW.
							<br>
							<br>
							Kerassentials makes no representations whatsoever about any other web site which
							you may access through this one or which may link to this Site. When you access
							a non- Kerassentials web site, please understand that it is independent from
							Kerassentials, and that Kerassentials has no control over the content on that web
							site. In addition, a link to a Kerassentials web site does not mean that Kerassentials endorses or accepts any responsibility for the content, or the use, of
							such web site.
							<br>
							<br>
							<b>
							...
							<br>
							You agree to indemnify, defend and hold harmless Kerassentials, its officers,
							...
							are for the benefit of Kerassentials and its officers, directors, employees,
							...
							legal action or proceeding between Kerassentials and you for any purpose concerning this Agreement or the parties’ obligations hereunder shall be brought exclusively in a
							...
							or cause of action arises or such claim or cause of action is barred. Kerassentials failure to insist upon or enforce strict performance of any provision of this Agreement
							...
							Kerassentials may assign its rights and duties under this Agreement to any party at any time without notice to you.
							<br>
							<br>
							<br>
      ...
      <div class="row">
         <div class="col-12">
            <div class="footer-menu">
               <ul class="pt-2">
                  <!-- <li class="footer-menu-links"><a href="https://thekerassentials.com/index.php" target="_blank">Home</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/text.php?#start-now">Get Started</a></li> -->
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/contact-us.php" target="_blank">Contact</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/references.php" target="_blank">References</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/terms.php" target="_blank">Terms Of Use</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/disclaimer.php" target="_blank">Disclaimer</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/privacy.php" target="_blank">Privacy Policy</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/shipping.php" target="_blank">Shipping Policy</a></li>
                  <li class="footer-menu-links"><a href="https://thekerassentials.com/help/refunds.php" target="_blank">Refund Policy</a></li>
               </ul>
            </div>
         </div>
      </div>
...
<div class="footer-middle-bg">
   <div class="container">
    ...
    <p>Testimonials, case studies, and examples found on this page are results that have been forwarded to us by users of Kerassentials products and related products, and may not reflect the typical purchaser's experience, may not apply to the average person and are not intended to represent or guarantee that anyone will achieve the same or similar results.</p>
...
<div class="footer-bottom-bg">
   ...
   <div class="text-center small">Copyright &copy; 2022 <b>Kerassentials</b> | All Rights Reserved</div>
   </div>
</div>
<script src="https://display.buygoods.com/v1/disclaimer?id=disclaimer&account_id=7085"></script>    </footer>
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K35JCCT"
